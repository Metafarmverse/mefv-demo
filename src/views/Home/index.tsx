  ...
  return (
    <>
      ...
      <StyledHeroSection
        ...
        background={
          theme.isDark
            ? 'radial-gradient(103.12% 50% at 50% 50%, #071120 0%, #0a7422 100%)'
            : 'linear-gradient(139.73deg, #071120 0%, #0a7422 100%)'
        }
        index={2}
      ...
      <PageSection
        innerProps={{ style: HomeSectionContainerStyles }}
        background="linear-gradient(180deg, #36db5c 0%, #0a7422 100%)"
        index={2}
        hasCurvedDivider={false}
      >
